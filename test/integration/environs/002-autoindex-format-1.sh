...
curl $(ap1/print_address.sh)/folder1?F=1
curl $(ap1/print_address.sh)/folder1?F=1 | grep -C10 file1.dat | grep file2.dat
curl $(ap1/print_address.sh)/folder1?F=1 | tidy -quiet -errors
